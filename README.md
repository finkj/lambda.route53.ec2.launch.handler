...
This small lambda function is updateing my DNS records in Route53 as soon as a instance has been successfully launched that is assigned to my application.

Partially this is just for studying purposes. There are other / more production ready solutions available in AWS like:
- Load Balancers
- Elastic IPs

But as i'm running my application on Spot instances and Amazon EC2 terminates, stops, or hibernates the Spot Instances when they need the capacity i need to handle my Route53 DNS Records after those events occure.

![](./EC2LaunchHandlerArchitecture.png)

## AWS SAM Autogenerated
